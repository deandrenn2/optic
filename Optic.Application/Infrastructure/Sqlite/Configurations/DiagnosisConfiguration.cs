...
public class DiagnosisConfiguration : IEntityTypeConfiguration<Diagnosis>
{
    public void Configure(EntityTypeBuilder<Diagnosis> builder)
    {
        ...
        builder.HasData(
            ...
            new Diagnosis(9, "UV", "Indica si las lentes tienen protección contra los rayos ultravioleta (UV)"),
            ...
            new Diagnosis(12, "DP", "Distancia Pupilar, Es la distancia entre la entrada del ojo y la salida del mismo, en milímetros"),
            new Diagnosis(13, "AB", "Este campo podría hacer referencia a la altura bifocal o algún otro ajuste específico de las lentes")
        );
    }
}