...
export const Sidebar = () => {
   return (
      <div
         id="sidebar"
         className=" bg-white  p-4 bg-gray-100 border-r"
      >
         <nav>
            <ul className="space-y-1">
               <li className="flex flex-col items-center rounded-lg p-1">
                  <a
                     href={`/`}
                     className="h-20 w-15 flex flex-col items-center rounded-lg p-4"
                  >
                     <FontAwesomeIcon
                        icon={faHouse}
                        className="h-20 w-14 flex flex-col items-center rounded-lg p-1"
                     />
