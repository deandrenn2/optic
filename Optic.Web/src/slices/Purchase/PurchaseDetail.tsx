    ...
    return (
        <div className="w-full">
            <div className="flex space-x-4 mb-4">
                <Link to={"/Billing"} title='Volver al listado' className="bg-gray-300 hover:bg-gray-300 text-gray-700 hover:text-gray-800 border border-gray-400 hover:border-gray-600 px-4 py-2 rounded font-bold flex items-center transition-all">
                    <FontAwesomeIcon
