...
export const FormulaProducts = ({ products, setProducts }: { products: ProductsResponseModel[], setProducts: React.Dispatch<React.SetStateAction<ProductsResponseModel[]>> }) => {
