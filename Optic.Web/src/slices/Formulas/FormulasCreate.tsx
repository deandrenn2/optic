            ...
            <div className="mb-1">
                ...
                <div className="grid grid-cols-2 mb-4 gap-4">
                    <div className="">
                        ...
                        <input name="priceConsultation" onChange={handleChange} type="text" className="w-full border border-gray-300 rounded p-1" value={formula?.priceConsultation} />
                    </div>
                    <div className="">
                        <label className="block text-gray-700 text-sm font-bold mb-2">Valor del lente {<MoneyFormatter amount={formula?.priceLens} />}</label>
                        <input name="priceLens" onChange={handleChange} type="text" className="w-full border border-gray-300 rounded p-1" value={formula?.priceLens} />
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap- mb-4">
                        <div>
                            <div className="flex justify-center">
                                ...
                                <p className=" right-0">Total: $400.000</p>
