...
export const FormulasDetail = () => {
    return (
        <div className="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black  bg-opacity-50  ">
            <div className=" justify-center items-center bg-gray-100 p-8 mb-1 rounded-lg border border-grey-500 p-1  fixed left-50 top-15">
                ...
                <div className="grid grid-cols-2 gap-2 mb-2">
                    <div>
                        <label className=" font-bold block text-sm font-medium mb-2">Cliente</label>
                        <input type="text" className=" border rounded min-w-80 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 " />
                    </div>

                    <div>
                        <label className="block text-sm font-medium">Fecha</label>
                        <div className="relative">
                            <input type="text" className=" border rounded min-w-80 py-2  text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 "
                            />
                ...
                <div className="grid grid-cols-2 gap-4 mb-1">
                    <div>
                        ...
                        <div className="">
                            <select className="shadow appearance-none rounded-tl-lg rounded-bl-lg min-w-64 py-2  text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option>Seleccione</option>
                            </select>
                             <button type="submit"
                                className="rounded-r-lg bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 font-bold">
                                Agregar
                            </button>
                        </div>
                        ...
                        <div className="relative">
                            <div className="flex items-center justify-between mb-4">
                                <input type="text" className="w-full border-2  p-2 px-4 " value="Progresivo" />
                                <button className="text-red-500"><FontAwesomeIcon icon={faCircleMinus} /></button>
                            </div>

                            <div className="relative">
                                <input type="text" className="w-full border-2  p-2 px-4 " value="Vidrio Blanco" />
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            <select className="shadow appearance-none rounded-tl-lg rounded-bl-lg min-w-64 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option>Seleccione</option>
                            </select>
                            <button type="submit"
                                className="rounded-r-lg bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 font-bold">
                        ...
                        <div>
                            ...
                            <div className="flex justify-center">
                                ...
                                <input type="number" value="1"
                                    className="w-12 border border-gray-300 rounded p-1 ml-2" />
                                <button className="text-red-500  justify-center mr-2"><FontAwesomeIcon icon={faCircleMinus} /></button>
                                <p className="absolute right-0">Total: $400.000</p>
                            </div>
                        </div>
